// // App.jsx - Complete version with Profile integration
...
// import ServicingProfile from './pages/servicing/Profile';
...
//                                           <a href="/profile" className="block text-green-600 hover:underline">User Profile</a>
//                                         </div>
//                                       </div>
...
// Common components
import Navbar from './components/common/Navbar';
import BuySellNavbar from './components/buysell/BuySellNavbar';
import Footer from './components/common/Footer';
import ProtectedRoute from './components/common/ProtectedRoute';
...
import Login from './pages/Login';
import Register from './pages/Register';
import Profile from './pages/Profile'; // User profile route
...
// Servicing Pages (updated imports from second file)
import ServicingHome from './pages/servicing/ServicingHome';
import HomePage from './pages/servicing/HomePage';
import Services from './pages/servicing/Services';
import ServicingProfile from './pages/servicing/Profile';
...
// BuySell Pages (updated imports from second file)
import BuySellHome from './pages/buysell/BuySellHome';
import BikeDetailsBuySell from './pages/buysell/BikeDetails';
import SellPage from './pages/buysell/SellPage';
import VehicleDetailsPage from './pages/buysell/VehicleDetailsPage';
import CallSellerPage from './pages/buysell/CallSellerPage';
import TextSellerPage from './pages/buysell/TextSellerPage';
import EnquiriesPage from './pages/buysell/EnquiriesPage';
import ChatPage from './pages/buysell/ChatPage';
import OwnerDetails from './pages/buysell/OwnerDetails';
...
// Navbar component to dynamically switch based on route
function NavbarComponent() {
  const location = useLocation();
  const currentPath = location.pathname;

  const isBuySellRoute =
    currentPath.startsWith('/buysell') ||
    currentPath === '/sell' ||
    currentPath.startsWith('/vehicle-details') ||
    currentPath.startsWith('/callseller') ||
    currentPath.startsWith('/textseller') ||
    currentPath === '/enquiries' ||
    currentPath.startsWith('/chat') ||
    currentPath.startsWith('/owner-details');

  return isBuySellRoute ? <BuySellNavbar /> : <Navbar />;
}
    ...
    <div className="text-center max-w-lg mx-auto p-8 bg-white rounded-2xl shadow-lg">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mb-6">
          The page you're looking for took a detour and got lost in the bike lanes!
        </p>
      </div>
      ...
      {isDevelopment && (
        <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg mb-6 text-sm">
          ...
          <p className="text-yellow-700 text-left">
            Current URL: <code className="bg-yellow-100 px-1 rounded">{window.location.pathname}</code>
          </p>
          <p className="text-yellow-700 text-left">
            Search Params: <code className="bg-yellow-100 px-1 rounded">{window.location.search || 'None'}</code>
          </p>
          <p className="text-yellow-700 text-left">
            Environment: <code className="bg-yellow-100 px-1 rounded">{import.meta.env.MODE}</code>
          </p>
        </div>
      )}
                    ...
                    <main className="flex-1">
                      <Routes>
                        ...
                        <Route
                          path="/rental/checkout"
                          element={
                            <ProtectedRoute requireAuth={true} redirectTo="/login" showRoleError={false}>
                              <RentalCheckout />
                            </ProtectedRoute>
                          }
                        />
                        ...
                        {/* BUYSELL ROUTES */}
                        <Route path="/buysell" element={<BuySellHome />} />
                        <Route path="/buysell/bike/:id" element={<BikeDetailsBuySell />} />
                        <Route path="/buysell/listing/:id" element={<BikeDetailsBuySell />} />
                        <Route
                          path="/buysell/my-listings"
                          element={
                            <ProtectedRoute>
                        ...
                        <Route path="/callseller/:id" element={<CallSellerPage />} />
                        <Route path="/callseller" element={<CallSellerPage />} />
                        <Route path="/textseller/:id" element={<TextSellerPage />} />
                        <Route path="/textseller" element={<TextSellerPage />} />
                        <Route
                          path="/enquiries"
                          element={
                            <ProtectedRoute>
                        ...
                        <Route
                          path="/admin/*"
                          element={
                            <ProtectedRoute requireAuth={true} requiredRole={USER_ROLES.ADMIN} showRoleError={true}>
                              <div className="min-h-screen bg-gray-50 py-8">
                                <div className="max-w-4xl mx-auto px-4">
                                  <div className="bg-white rounded-lg shadow p-8 text-center">
                                    <div className="text-6xl mb-4">👨‍💼</div>
                                  ...
                                  <div className="bg-white rounded-lg shadow-lg p-8">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                      <div className="bg-green-50 p-4 rounded-lg">
                                        <h3 className="text-lg font-semibold mb-3 text-green-800">🚲 Rental Routes</h3>
                                        <div className="space-y-2">
                                          <a href="/rental" className="block text-green-600 hover:underline">
                                            Rental Home
                                          </a>
                                          <a href="/bikes" className="block text-green-600 hover:underline">
                                            Bike List
                                          </a>
                                          <a href="/profile" className="block text-green-600 hover:underline">
                                            User Profile
                                          </a>
                                        </div>
                                      </div>
