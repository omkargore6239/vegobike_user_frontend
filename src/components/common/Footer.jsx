    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-bold mb-4">BikeHub</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/rental" className="text-gray-400 hover:text-white">Bike Rental</Link></li>
              <li><Link to="/servicing" className="text-gray-400 hover:text-white">Bike Servicing</Link></li>
              <li><Link to="/spareparts" className="text-gray-400 hover:text-white">Spare Parts</Link></li>
              <li><Link to="/buysell" className="text-gray-400 hover:text-white">Buy/Sell</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2025 BikeHub. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
